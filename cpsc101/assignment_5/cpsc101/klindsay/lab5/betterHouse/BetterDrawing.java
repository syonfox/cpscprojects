...
class BetterDrawing extends Drawing {
  ...
  public BetterDrawing(int ix, int iy, int iw, int ih) {
    if(x+w > getSize().getWidth()) System.out.println("Warning: some of the house is cut off");
    if(y+h > getSize().getHeight()) System.out.println("Warning: some of the house is cut off");
    x=ix;
    y=iy;
    w=iw;
    h=ih;
