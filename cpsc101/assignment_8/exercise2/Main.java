...
public class Main {
  ...
  public static void processReport(EmployeeFactory employeeFactory, Reader in, Writer out ) throws IOException {
    ...
    while( sc.hasNext() ) {
      ...
      current = employeeFactory.getFreshEmployee(eType);
      /*switch(eType) {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      EmployeeFactory employeeFactory = new FlexibleFactory();
      processReport(employeeFactory, reader , writer);
    } catch(IOException e) {
